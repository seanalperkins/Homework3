...
Greg Carter: https://github.com/GregCart2/Homework3-1
- number of successful pull requests made: 1
-   github repository to which a change was requested: https://github.com/seanalperkins/Homework3
- number of pull requests accepted: 1
-   the github repository from which you accepted:  https://github.com/seanalperkins/Homework3
Shelby Nechkash: https://github.com/shelbob/Homework3-1
- number of successful pull requests made: 
-   github repository to which a change was requested: 
- number of pull requests accepted: 
-   the github repository from which you accepted: 
Seana Perkins: https://github.com/seanalperkins/Homework3
- number of successful pull requests made: 
-   github repository to which a change was requested: 
- number of pull requests accepted: 
-   the github repository from which you accepted: 
...
1. Have clear repository names so it's easy to get to the file(s) you need
2. Make notes of descriptions of overall changes being made
3. Update branch regularly
...
stats <- read.csv("./gapminder-5060.csv")
stats_us = stats[stats$country == "United States", ]

ggplot(data = stats_us, aes(x=gdpPercap, y=lifeExp, color=country, size=log(pop))) + geom_point() + geom_line(aes(x=gdpPercap, y=lifeExp, color=country))
```
